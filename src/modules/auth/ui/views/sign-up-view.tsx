...
export const SignUpView = () => {
    ...
    return(
        <div className="flex flex-col gap-6">
            <Card className="overflow-hidden p-0">
                <CardContent className="grid p-0 md:grid-cols-2">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input type="email" placeholder="m@abc.com" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                    ...
                    <div className="bg-radial from-sidebar-accent to-sidebar relative hidden md:flex flex-col gap-y-4 items-center justify-center">
                        <Image src="/logo.svg" alt="Image" className="h-[92px] w-[92px]"></Image>
            ...
            <div className="text-muted-foregroungd *:[a]:hover:text=primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
